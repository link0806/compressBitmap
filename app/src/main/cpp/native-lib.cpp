...
Java_com_link_compressbitmapwithjpeg_JpegUtils_compressBitmapPath(JNIEnv *env, jclass type, jobject bitmap,
    ...
    int result = generateJPEG(tempData, width, height, quality, filename, true);
